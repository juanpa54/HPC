...
int main(int argc, char* argv[])
{
    ...
    //std::cout<<var_prom_independientes<<std::endl;
    ...
    Eigen::VectorXd var_desv_independientes;
    var_desv_independientes << 21.1577,  258.548,   5.6311, 0.905115, 0.498786, 0.346474,  0.29704,  74.8353,  7.87398;
    Eigen::VectorXd var_prom_independientes;
    var_prom_independientes<<52.011, 416.602,  8.28695,  14.6087, 0.464611, 0.139479, 0.902221,221.301,15.927;
